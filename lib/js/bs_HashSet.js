...
function forEach(h, f) {
  return Bs_internalSetBuckets.iter0(h.data, f);
}

function reduce(h, init, f) {
  return Bs_internalSetBuckets.fold0(h.data, init, f);
}
...
var forEach0 = Bs_internalSetBuckets.iter0;

var reduce0 = Bs_internalSetBuckets.fold0;
